package com.kingsoft.day03.testcases;

import com.kingsoft.day03.common.BaseTest;
import com.kingsoft.day03.pages.IndexPage;
import com.kingsoft.day03.pages.LoginPage;
import com.kingsoft.day03.pages.MylemonPage;
import com.kingsoft.day03.pages.tiku.DifficultLevelPage;
import com.kingsoft.day03.pages.tiku.SubjectDetailPage;
import com.kingsoft.day03.pages.tiku.SubjectListPage;
import com.kingsoft.day03.pages.tiku.TikuPage;
...
public class TikuTest extends BaseTest{
    ...
    public void tikuAnswerShow() throws InterruptedException {
        ...
        //(3)随机选择一个难度级别
        DifficultLevelPage difficultLevelPage = new DifficultLevelPage(driver);
        difficultLevelPage.randomSelectDifficultLevel();
        Thread.sleep(2000);

        //(4)随机选取一套题
        SubjectListPage subjectListPage = new SubjectListPage(driver);
    ...
    public void testCollectSubject() throws InterruptedException {
        ...
        backToIndexPage();
        indexPage.enterMylemonPage();
        mylemonPage = new MylemonPage(driver);
    ...
    //            driver.findElement(MobileBy.xpath("//*[@text='"+findText+"']")).click();
    //            break;
    //        }
    //        swipeUp(1000);
